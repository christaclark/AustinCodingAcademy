...
class Person:
    ...
    def __init__(self, name, age, street_address, bank_balance):
        """
        Create a new person
...
if __name__ == "__main__":
    shopper = Person('Samir', 30, '5421 Hickory Dr', 5500.00)
...
# Function to read above script from file 
...
def read_order_data_from_file():
	order_info = file2dicts() # a list of things like ('cost', 'product', 'name')
	people_by_name = {}
	products_by_name = {}
	...
	for order_item in order_info:
		...
		product = products_by_name[ product_name].add_product	
